...
const PropertyOverview: React.FC<PropertyOverviewProps> = ({ property, propertyOverview }) => {
    ...
    //                 `Write a short under 200 words overview of the property i.e. ${JSON.stringify(property)} for home buyers covering all technical aspects related to property.`
    //             );
    ...
    return (
        <div className="rounded-lg border border-gray-300 bg-white shadow-lg overflow-hidden p-6 mt-4">
            <div className="flex flex-col justify-between text-center items-center">
                <h2 className="text-lg font-semibold text-gray-800">HouseGPT Property Overview</h2>
                ...
                {/* {loading ? (
                    ...
                    <>
                        <p className="text-gray-700 text-sm items-center text-center">
                            {isExpanded ? (propertyOverview || defaultOverview) : `${(propertyOverview || defaultOverview).slice(0, 300)}...`}
                        </p>
